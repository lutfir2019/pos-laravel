<div>
    <div class="flex flex-wrap px-2 py-3">
        ...
        <div class="mb-6 flex justify-center gap-4 items-center w-full">
            ...
            <x-button primary type="button" wire:click="sync" wire:loading.attr="disabled" class="ml-2 font-bold">Refresh</x-button>
        </div>
        ...
        @can('show_total_stats')
            ...
            <div class="sm:w-1/4 w-1/2 px-2 pb-2">
                <x-counter-card color="green" counter="{{ format_currency($salesTotal) }}" :title="__('Sales Total')"
                    href="{{ route('sales.index') }}">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                    </path>
            ...
            <div class="sm:w-1/4 w-1/2 px-2 pb-2">
                <x-counter-card color="gray" counter="{{ format_currency($stockValue) }}" :title="__('Stock Value')" href="#">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z">
                    </path>
                </x-counter-card>
    ...
    <div class="px-2 pb-2 mt-2 w-full">
        <div class="bg-white rounded-lg border border-gray-200 pb-2">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th class="text-left px-4">{{ __('Seller') }}</th>
                        <th class="text-left px-4">{{ __('Product Name') }}</th>
                        <th class="text-left px-4">{{ __('Warehouse') }}</th>
                ...
                <tbody>
                    @foreach ($lastSales as $sale)
                        <tr class="text-sm antialiased">
                            <td class="px-4 py-2">
                                <p class="font-bold tracking-wide text-gray-800">{{ $sale->user?->name }}
                                </p>
                                <span class="text-indigo-600 text-xs font-semibold">{{ $sale->reference }}</span>
                            </td>
                            <td class="px-4 py-2">{{ $sale?->saleDetails[0]?->product?->name }}</td>
                            <td class="px-4 py-2">{{ $sale?->saleDetails[0]?->warehouse?->name }}</td>
